...
#
{
  ...
  home = {
    ...
    activation = {
      # Run script during rebuild/switch.
      linkDesktopApplications = {
        # Script that will add all packages to the system menu. Mainly tested on Gnome.
        after = ["writeBoundary" "createXdgUserDirectories"];
        before = [];
        data = "sudo /user/bin/update-desktop-database"; # This will update the database, requires sudo. Not recommended to install via home-manager so do it manually for your distro
      };
